define(['jquery', 'bootstrap', 'backend', 'form', 'table'], function ($, undefined, Backend, Form, Table) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'qw/attachment/index',
                    add_url: 'qw/attachment/add',
                    edit_url: 'qw/attachment/edit',
                    del_url: 'qw/attachment/del',
                    multi_url: 'qw/attachment/multi',
                    table: 'qw_attachment',
                }
            });
        ...
        select: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'qw/attachment/select',
                }
            });
