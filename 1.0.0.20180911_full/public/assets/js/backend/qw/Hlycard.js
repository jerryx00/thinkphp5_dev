define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'qw/hlycard/index',
                    add_url: 'qw/hlycard/add',
//                    edit_url: '',
...
//                    multi_url: '',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        //直接响应搜索                          
                        //模糊搜索
                        {field: 'TelNum', title: __('Title'), operate: 'LIKE %...%', placeholder: '模糊搜索，*表示任意字符', style: 'width:200px'},
                        //通过Ajax渲染searchList
            ...
            $(document).on("click", ".btn-detail[data-id]", function () {
                Backend.api.open('qw/hlycard/locknum/ids/' + $(this).data('id'), __('Detail'));
            });
